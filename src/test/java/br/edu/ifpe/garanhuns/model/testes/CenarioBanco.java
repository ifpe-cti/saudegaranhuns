...
public class CenarioBanco {
    ...
    public void iniciarBancoTest() throws SQLException {
        ...
        sgbd.query("INSERT INTO Atendimento VALUES (5,0, 1)");
        sgbd.query("INSERT INTO HorarioAtendimento VALUES (5 ,5, \"07:00\", \"13:00\", 10, 5)");

        sgbd.query("INSERT INTO Atendimento VALUES (6, 0, 2)");
        sgbd.query("INSERT INTO HorarioAtendimento VALUES (6, 2, \"18:00\", \"19:00\", 10, 6)");
        ...
        LocalDate da = LocalDate.now().plusDays(1);

        sgbd.query("INSERT INTO Consulta VALUES (1, \"" + da + "\",\"" + ds + "\", 0, 0, 1,  1)");
    }
