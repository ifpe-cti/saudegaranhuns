...
public class NewClass {
 ...
 /*       
        ...
        cH.inserir(new Consulta(Especialidade.GERAL, Prioridade.DEFICIENTEFISICO, Status.AGENDADO, LocalDate.now(), LocalDate.now().plusDays(1), new Paciente("João1", "1231", LocalDate.of(1995, 01, 01), new PostoSaude("Casa de deus1", new Endereco("11", "rua rua1", new Bairro("não sei"))), new Usuario("a1231", "123", PerfilUsuario.PACIENTE))));
        cH.inserir(new Consulta(Especialidade.DENTISTA, Prioridade.GESTANTE, Status.AGENDADO, LocalDate.now(), LocalDate.now().plusDays(1), new Paciente("João1", "1231", LocalDate.of(1995, 01, 01), new PostoSaude("Casa de deus1", new Endereco("11", "rua rua1", new Bairro("não sei"))), new Usuario("a1231", "123", PerfilUsuario.PACIENTE))));
        ...
        cH.inserir(new Consulta(Especialidade.GERAL, Prioridade.BEBEDECOLO, Status.AGENDADO, LocalDate.now(), LocalDate.now().plusDays(3), new Paciente("João1", "1231", LocalDate.of(1995, 01, 01), new PostoSaude("Casa de deus1", new Endereco("11", "rua rua1", new Bairro("não sei"))), new Usuario("a1231", "123", PerfilUsuario.PACIENTE))));
        cH.inserir(new Consulta(Especialidade.DENTISTA, Prioridade.DEFICIENTEFISICO, Status.AGENDADO, LocalDate.now(), LocalDate.now().plusDays(3), new Paciente("João1", "1231", LocalDate.of(1995, 01, 01), new PostoSaude("Casa de deus1", new Endereco("11", "rua rua1", new Bairro("não sei"))), new Usuario("a1231", "123", PerfilUsuario.PACIENTE))));
        ...
        cH.inserir(new Consulta(Especialidade.DENTISTA, Prioridade.BEBEDECOLO, Status.AGENDADO, LocalDate.now(), LocalDate.now().plusDays(5), new Paciente("João1", "1231", LocalDate.of(1995, 01, 01), new PostoSaude("Casa de deus1", new Endereco("11", "rua rua1", new Bairro("não sei"))), new Usuario("a1231", "123", PerfilUsuario.PACIENTE))));
        cH.inserir(new Consulta(Especialidade.GERAL, Prioridade.DEFICIENTEFISICO, Status.AGENDADO, LocalDate.now(), LocalDate.now().plusDays(5), new Paciente("João1", "1231", LocalDate.of(1995, 01, 01), new PostoSaude("Casa de deus1", new Endereco("11", "rua rua1", new Bairro("não sei"))), new Usuario("a1231", "123", PerfilUsuario.PACIENTE))));
